    ...
    return (
        <>
            ...
            <div className="container" style={{ padding: '100px 20px', maxWidth: '800px' }}>
                ...
                <p className="text-body" style={{ marginBottom: '2rem', fontStyle: 'italic' }}>Last updated: 29/01/2026</p>
                ...
                <div className="text-body">
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>2. How We Use Your Information</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>3. Affiliate Links & Third-Party Platforms</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>4. Product Images & Content</h3>
                    <p>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>5. Login & Authentication</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>6. Camera & Media Access</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>7. Data Sharing</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>8. Data Security</h3>
                    <p>
                        We take reasonable measures to protect user information and prevent unauthorized access, misuse, or loss of data.
                    </p>

                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>9. Children’s Privacy</h3>
                    <p>
                        MEGG is not intended for children under the age of 13. We do not knowingly collect personal data from children.
                    </p>

                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>10. Changes to This Privacy Policy</h3>
                    <p>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>11. Contact Us</h3>
