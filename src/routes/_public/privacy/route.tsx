        ...
        <>
            ...
            <div className="container" style={{ padding: '100px 20px', maxWidth: '800px' }}>
                ...
                <div className="text-body">
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>1. Information we collect</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>2. How we use your information</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>3. Affiliate links & third-party platforms</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>4. Product images & content</h3>
                    <p>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>5. Login & authentication</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>6. Camera & media access</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>7. Data sharing</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>8. Data security</h3>
                    <p>
                        We take reasonable measures to protect user information and prevent unauthorized access, misuse, or loss of data.
                    </p>

                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>9. Data retention</h3>
                    <p>
                        We retain your data only as long as necessary to provide our services or as required by law.
                    </p>

                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>10. Children's privacy</h3>
                    <p>
                        MEGG is not intended for children under the age of 13. We do not knowingly collect personal data from children.
                    </p>

                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>11. Changes to this privacy policy</h3>
                    <p>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>12. User rights</h3>
                    <p>
                        You may request deletion of your account and associated data by contacting us at meggxfashion@gmail.com.
                    </p>

                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>13. Contact us</h3>
