        ...
        <>
            ...
            <div className="container" style={{ padding: '100px 20px', maxWidth: '800px' }}>
                ...
                <div className="text-body">
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>1. About MEGG</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>2. Eligibility</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>3. Use of the App</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>4. Login & Access</h3>
                    <ul style={{ listStyle: 'disc', paddingLeft: '20px', marginBottom: '1rem' }}>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>5. Affiliate Links & Third-Party Platforms</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>6. Product Information & Accuracy</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>7. Intellectual Property</h3>
                    <ul style={{ listStyle: 'disc', paddingLeft: '20px', marginBottom: '1rem' }}>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>8. Camera & App Features</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>9. Limitation of Liability</h3>
                    <p style={{ marginBottom: '1rem' }}>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>10. Termination</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>11. Changes to These Terms</h3>
                    <p>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>12. Governing Law</h3>
                    <p>
                        These Terms are governed by and interpreted in accordance with the laws of India.
                    </p>

                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>13. Contact Information</h3>
