        ...
        <>
            ...
            <div className="container" style={{ padding: '100px 20px', maxWidth: '800px' }}>
                ...
                <div className="text-body">
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>1. About MEGG</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>2. Eligibility</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>3. Use of the app</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>4. Login & access</h3>
                    <ul style={{ listStyle: 'disc', paddingLeft: '20px', marginBottom: '1rem' }}>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>5. Affiliate links & third-party platforms</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>6. Product information & accuracy</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>7. Intellectual property</h3>
                    <ul style={{ listStyle: 'disc', paddingLeft: '20px', marginBottom: '1rem' }}>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>8. Camera & app features</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>9. Limitation of liability</h3>
                    <p style={{ marginBottom: '1rem' }}>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>10. User rights</h3>
                    <p>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>11. Termination</h3>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>12. Changes to these terms</h3>
                    <p>
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>13. Governing law</h3>
                    <p>
                        These Terms are governed by and interpreted in accordance with the laws of India.
                    </p>

                    <h3 style={{ fontSize: '1.2rem', marginTop: '3rem', marginBottom: '1rem', fontWeight: '400' }}>14. Contact information</h3>
